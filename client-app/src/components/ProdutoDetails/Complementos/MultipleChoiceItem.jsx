...
const MultipleChoiceItem = ({ item, isComplemento, currentQuantity, onQuantityChange }) => {
    ...
    return (
        <div className="flex items-center justify-between bg-white p-3 rounded-lg shadow-sm">
            <div className="flex-1">
                ...
                {maxQuantity > 1 && (
                    <p className="text-xs text-gray-500">Máximo: {maxQuantity}</p>
                )}
                {maxQuantity === 1 && (
                    <p className="text-xs text-gray-500">No máximo 1</p>
                )}
            </div>
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    disabled={currentQuantity >= maxQuantity || !disponivel}
                >
